...
-   <span class="package-name">[`@stdlib/error-tools-pkg2id-cli`][@stdlib/error-tools-pkg2id-cli]</span><span class="delimiter">: </span><span class="description">CLI package for use as a command-line utility.</span>
...
[@stdlib/error-tools-pkg2id-cli]: https://www.npmjs.com/package/@stdlib/error-tools-pkg2id-cli
